...
SRC_URI="${GENPATCHES_URI} ${KERNEL_URI} ${ARCH_URI}
		https://github.rc1844.workers.dev/graysky2/kernel_compiler_patch/raw/master/more-uarches-for-kernel-5.15%2B.patch -> more-uarches-for-kernel-${SHPV}%2B-${PV}.patch
		https://github.rc1844.workers.dev/HougeLangley/customkernel/releases/download/v${SHPV}-patch/v1-cjktty-${SHPV}.patch
